...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { description: @shoe.description, name: @shoe.name, picture: @shoe.picture, price: @shoe.price } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { description: @shoe.description, name: @shoe.name, picture: @shoe.picture, price: @shoe.price } }
